...
/**
 * A helper class for {@link androidx.paging.PagedList.BoundaryCallback PagingBoundaryCallback}s and
 ...
 * <pre>
 * class PagingBoundaryCallback extends PagedList.PagingBoundaryCallback&lt;MyItem> {
...
public class PagingRequestHelper {
    ...
    public interface Request {
        ...
        class Callback {
            ...
            /**
             * Call this method with the failure messageResId and the request can be retried via
             * {@link #retryAllFailed()}.
             *
            ...
            public final void recordFailure(@NonNull Throwable throwable) {
                ...
                if (throwable == null) {
                    throw new IllegalArgumentException("You must provide a exception describing"
    ...
    public enum RequestType {
         ...
         * a {@link androidx.paging.PagedList.BoundaryCallback PagingBoundaryCallback}.
         */
        INITIAL,
        /**
         * Corresponds to the {@code loadBefore} calls in {@link DataSource} or
         * {@code onItemAtFrontLoaded} in
         * {@link androidx.paging.PagedList.BoundaryCallback PagingBoundaryCallback}.
         */
        BEFORE,
        /**
